<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FindBloodDonor1.aspx.cs" Inherits="Bloodbank1.FindBloodDonor1" %>
            ...
            <tr>
                ...
                <td colspan="3" rowspan="5">
                    <table class="w-100">
                        <tr>
                            <td>
                                <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" CssClass="auto-style11" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                    <Columns>
